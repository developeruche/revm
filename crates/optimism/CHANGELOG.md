...
## [2.1.0](https://github.com/developeruche/revm/compare/op-revm-v2.0.0...op-revm-v2.1.0) - 2025-04-05
...
- *(op-inspector)* Add test for inspecting logs ([#2352](https://github.com/developeruche/revm/pull/2352))
- *(op-tx)* Cover DepositTransactionParts constructor in test ([#2358](https://github.com/developeruche/revm/pull/2358))

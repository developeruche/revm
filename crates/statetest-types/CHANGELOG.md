...
## [17.1.0](https://github.com/developeruche/revm/compare/revm-statetest-types-v17.0.0...revm-statetest-types-v17.1.0) - 2026-04-23

### Added

- *(statetest-types)* add slot_number support (EIP-7843) ([#3391](https://github.com/developeruche/revm/pull/3391))
...
- remove unused bytecode dependency from revm-statetest-types ([#3485](https://github.com/developeruche/revm/pull/3485))
...
- *(statetest-types)* add BPO2ToAmsterdamAtTime15k fork spec ([#3397](https://github.com/developeruche/revm/pull/3397))
...
- *(btest)* 0 chainid is considered none ([#3022](https://github.com/developeruche/revm/pull/3022))
...
- remove parent blob gas used and excess ([#2933](https://github.com/developeruche/revm/pull/2933))
...
- revm-statetest-types to alpha5 ([#2220](https://github.com/developeruche/revm/pull/2220))
...
- allow duplicate v and yparity in test files ([#2150](https://github.com/developeruche/revm/pull/2150))
...
- bump devnet5 v1.3.0 tests ([#2020](https://github.com/developeruche/revm/pull/2020))

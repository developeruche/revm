...
## [34.0.0](https://github.com/developeruche/revm/compare/revm-precompile-v33.0.0...revm-precompile-v34.0.0) - 2026-04-23
...
- rm gmp use-system-libs ([#3253](https://github.com/developeruche/revm/pull/3253))
- dynamically link gmp ([#3250](https://github.com/developeruche/revm/pull/3250))
- *(precompiles)* add performant PrecompileError::OtherCowStr variant ([#3144](https://github.com/developeruche/revm/pull/3144))
...
- optimize access to precompile short addresses ([#2846](https://github.com/developeruche/revm/pull/2846))
...
- rename bn128 to bn254 for Ethereum standard consistency ([#2810](https://github.com/developeruche/revm/pull/2810))
- *(precompiles)* Use bytes API for underlying precompile library APIs ([#2705](https://github.com/developeruche/revm/pull/2705))
- *(precompile)* update osaka modexp gas divisor ([#2740](https://github.com/developeruche/revm/pull/2740))
- *(precompile)* update p256 verify osaka gas cost ([#2741](https://github.com/developeruche/revm/pull/2741))
...
- *(osaka)* modexp assume minimal base/mod length of 32 ([#2613](https://github.com/developeruche/revm/pull/2613)) ([#2643](https://github.com/developeruche/revm/pull/2643))
- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/developeruche/revm/pull/2596))
- add basic tests for modexp ([#2603](https://github.com/developeruche/revm/pull/2603))
...
- *(Osaka)* modexp input limit and gas change, EIP-7823 and EIP-7883 ([#2531](https://github.com/developeruche/revm/pull/2531))
...
- *(precompile)* use big-endian resize for modexp output padding ([#3432](https://github.com/developeruche/revm/pull/3432))
- *(kzg/blst)* use uncompress for compressed G1/G2 inputs ([#3067](https://github.com/developeruche/revm/pull/3067))
- racecondition return on install_crypto fn ([#2997](https://github.com/developeruche/revm/pull/2997))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/developeruche/revm/pull/2978))
- *(osaka)* do base/mod zero check after gas calc ([#2872](https://github.com/developeruche/revm/pull/2872))
...
- *(isthmus)* Add input size limitations to bls12-381 {G1/G2} MSM + pairing ([#2406](https://github.com/developeruche/revm/pull/2406))
...
- *(precompile)* take large array args by reference ([#3524](https://github.com/developeruche/revm/pull/3524))
- add secp256r1 (P256) precompile benchmark ([#3525](https://github.com/developeruche/revm/pull/3525))
...
- *(precompile)* zero-copy scalar conversion in BLS12-381 MSM ([#3359](https://github.com/developeruche/revm/pull/3359))
- use fixed bytes hashmaps from alloy-core ([#3358](https://github.com/developeruche/revm/pull/3358))
- *(precompiles)* cache trusted setup G2 for kzg ([#3322](https://github.com/developeruche/revm/pull/3322))
- rename misleading calc_linear_cost_u32 function ([#3318](https://github.com/developeruche/revm/pull/3318))
...
- *(precompile)* extract common pairing_check_bytes logic in bls12_381 ([#3301](https://github.com/developeruche/revm/pull/3301))
...
- optimize precompile `extend()` ([#3192](https://github.com/developeruche/revm/pull/3192))
...
- *(precompile)* remove unused mainnet_address() function ([#3091](https://github.com/developeruche/revm/pull/3091))
...
- typo imputs ([#3031](https://github.com/developeruche/revm/pull/3031))
- add display for precompileid ([#3018](https://github.com/developeruche/revm/pull/3018))
- Remove libsecp256k1 parity lib ([#2954](https://github.com/developeruche/revm/pull/2954))
- add SECURITY.md ([#2956](https://github.com/developeruche/revm/pull/2956))
- add amsterdam in spec id ([#2934](https://github.com/developeruche/revm/pull/2934))
- cargo update ([#2930](https://github.com/developeruche/revm/pull/2930))
- *(precompile)* add new specific `PrecompileError` variants ([#2907](https://github.com/developeruche/revm/pull/2907))
- add Precompil::into_precompile ([#2913](https://github.com/developeruche/revm/pull/2913))
...
- simplify the ecrecover test ([#2836](https://github.com/developeruche/revm/pull/2836))
...
- add OnceLock re-export with no_std support ([#2787](https://github.com/developeruche/revm/pull/2787))
...
- use `EncodedPoint` to decode uncompressed public key ([#2736](https://github.com/developeruche/revm/pull/2736))
- *(precompile)* refactor blake2 input parsing ([#2734](https://github.com/developeruche/revm/pull/2734))
- Add blake2 benchmarks ([#2735](https://github.com/developeruche/revm/pull/2735))
...
- use c-kzg precompute value 8 ([#2698](https://github.com/developeruche/revm/pull/2698))
...
- build less benchmark binaries ([#2629](https://github.com/developeruche/revm/pull/2629))
...
- fixed dead link kzg_point_evaluation.rs ([#2508](https://github.com/developeruche/revm/pull/2508))
...
- make OPCODE_INFO a static ([#2459](https://github.com/developeruche/revm/pull/2459))
...
- *(docs)* precompile crate ([#2413](https://github.com/developeruche/revm/pull/2413))
- bump stable tests, introduce lints ([#2403](https://github.com/developeruche/revm/pull/2403))
- bump v68 revm v22.0.0 ([#2396](https://github.com/developeruche/revm/pull/2396))
- fixed `EIP` to `RIP` ([#2388](https://github.com/developeruche/revm/pull/2388))
- *(precompile)* remove unused dependencies ([#2378](https://github.com/developeruche/revm/pull/2378))
...
- integrate rust-secp256k1 ([#1915](https://github.com/developeruche/revm/pull/1915))

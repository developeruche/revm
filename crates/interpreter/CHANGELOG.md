...
## [36.0.0](https://github.com/developeruche/revm/compare/revm-interpreter-v35.0.0...revm-interpreter-v36.0.0) - 2026-04-23

### Added

- add EIP-8037 / TIP-1016 state gas support ([#3406](https://github.com/developeruche/revm/pull/3406))
- Add local context accessors to CallInput ([#3537](https://github.com/developeruche/revm/pull/3537))
- add CallInput::as_bytes ([#3515](https://github.com/developeruche/revm/pull/3515))
- add crate-level re-exports for all revm-* dependencies ([#3507](https://github.com/developeruche/revm/pull/3507))
- Part of amsterdam devnet3 EIP updates ([#3438](https://github.com/developeruche/revm/pull/3438))
- Implement EIP-7843 SLOTNUM opcode for Amsterdam ([#3340](https://github.com/developeruche/revm/pull/3340))
- Implement EIP-8024 for Amsterdam ([#3223](https://github.com/developeruche/revm/pull/3223))
- add `new_oog` helpers to InterpreterResult, CallOutcome, CreateOutcome, and FrameResult ([#3309](https://github.com/developeruche/revm/pull/3309))
- new gas params, tx initial gas and codedeposit ([#3260](https://github.com/developeruche/revm/pull/3260))
- move GasParams to Cfg ([#3229](https://github.com/developeruche/revm/pull/3229))
- BAL EIP-7928 ([#3070](https://github.com/developeruche/revm/pull/3070))
- Gas params ([#3132](https://github.com/developeruche/revm/pull/3132))
- *(create)* Implement Cache for CreateInputs::created_address ([#3218](https://github.com/developeruche/revm/pull/3218))
- process precompile logs to inspector ([#3148](https://github.com/developeruche/revm/pull/3148))
- selfdestruct oog on cold load ([#3140](https://github.com/developeruche/revm/pull/3140))
- *(precompiles/jovian)* add jovian precompiles to revm ([#3128](https://github.com/developeruche/revm/pull/3128)) ([#3134](https://github.com/developeruche/revm/pull/3134))
- Optional Bytecode in CallInput ([#3110](https://github.com/developeruche/revm/pull/3110))
- Support bubbling up first precompile error messages  ([#2905](https://github.com/developeruche/revm/pull/2905))
- send bytecode with call input ([#2963](https://github.com/developeruche/revm/pull/2963))
- short address for journal cold/warm check ([#2849](https://github.com/developeruche/revm/pull/2849))
- gastable, record static gas in Interpreter loop ([#2822](https://github.com/developeruche/revm/pull/2822))
- *(interpreter)* update CLZ cost ([#2739](https://github.com/developeruche/revm/pull/2739))
- blake2 avx2 ([#2670](https://github.com/developeruche/revm/pull/2670))
- remove EOF ([#2644](https://github.com/developeruche/revm/pull/2644))
- configurable contract size limit ([#2611](https://github.com/developeruche/revm/pull/2611)) ([#2642](https://github.com/developeruche/revm/pull/2642))
- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/developeruche/revm/pull/2596))
- add clz opcode ([#2598](https://github.com/developeruche/revm/pull/2598))
- added instruction_result fn in LoopControl trait  ([#2595](https://github.com/developeruche/revm/pull/2595))
- expand timestamp/block_number to u256 ([#2546](https://github.com/developeruche/revm/pull/2546))
- transact multi tx ([#2517](https://github.com/developeruche/revm/pull/2517))
- expose Gas::memory field ([#2512](https://github.com/developeruche/revm/pull/2512))
- added CallInput::bytes<CTX>(ctx: &CTX) -> Bytes {} function ([#2507](https://github.com/developeruche/revm/pull/2507))
- *(Osaka)* disable EOF ([#2480](https://github.com/developeruche/revm/pull/2480))
- skip cloning of call input from shared memory ([#2462](https://github.com/developeruche/revm/pull/2462))
- Add a custom address to the CreateScheme. ([#2464](https://github.com/developeruche/revm/pull/2464))
- replace input Bytes and refactored code where required ([#2453](https://github.com/developeruche/revm/pull/2453))
- *(EOF)* Changes needed for devnet-1 ([#2377](https://github.com/developeruche/revm/pull/2377))
- Move SharedMemory buffer to context ([#2382](https://github.com/developeruche/revm/pull/2382))
...
- allow reuse of API for calculating initial tx gas for tx ([#2215](https://github.com/developeruche/revm/pull/2215))
- *(docs)* MyEvm example and book cleanup ([#2218](https://github.com/developeruche/revm/pull/2218))
- add custom error to context ([#2197](https://github.com/developeruche/revm/pull/2197))
- remove specification crate ([#2165](https://github.com/developeruche/revm/pull/2165))
- Standalone Host, remove default fn from context ([#2147](https://github.com/developeruche/revm/pull/2147))
- allow host to be implemented on custom context ([#2112](https://github.com/developeruche/revm/pull/2112))
...
- Add essential EIP-7756 tracing fields ([#2023](https://github.com/developeruche/revm/pull/2023))
...
- align Block trait ([#1957](https://github.com/developeruche/revm/pull/1957))
...
- *(interpreter)* impl Clone for Stack ([#1820](https://github.com/developeruche/revm/pull/1820))
...
- *(EOF)* add evmone test suite ([#1689](https://github.com/developeruche/revm/pull/1689))
- check for typos in CI ([#1686](https://github.com/developeruche/revm/pull/1686))
- *(EOF)* Add non-returning CALLF/JUMPF checks ([#1663](https://github.com/developeruche/revm/pull/1663))
- *(EOF)* EOF Validation add code type and sub container tracker ([#1648](https://github.com/developeruche/revm/pull/1648))
- *(EOF)* implement std::error::Error trait for EofValidationError and EofError ([#1649](https://github.com/developeruche/revm/pull/1649))
- *(interpreter)* derive traits on FunctionStack ([#1640](https://github.com/developeruche/revm/pull/1640))
- *(eof)* cli eof-validation ([#1622](https://github.com/developeruche/revm/pull/1622))
...
- support selfdestruct for dummyhost ([#1578](https://github.com/developeruche/revm/pull/1578))
...
- *(EOF)* change oob behavior of RETURNDATALOAD and RETURNDATACOPY ([#1476](https://github.com/developeruche/revm/pull/1476))
- *(EOF)* EIP-7698 eof creation transaction ([#1467](https://github.com/developeruche/revm/pull/1467))
- adjust gas-costs for EIP-2935 BLOCKHASH ([#1422](https://github.com/developeruche/revm/pull/1422))
- add Opcode::modifies_memory back ([#1421](https://github.com/developeruche/revm/pull/1421))
- *(EOF)* Add CALLF/JUMPF stack checks ([#1417](https://github.com/developeruche/revm/pull/1417))
- *(EOF)* remove TXCREATE ([#1415](https://github.com/developeruche/revm/pull/1415))
- implement EIP-2935 ([#1354](https://github.com/developeruche/revm/pull/1354))
- parse opcodes from strings ([#1358](https://github.com/developeruche/revm/pull/1358))
...
- *(interpreter)* derive Eq for InterpreterAction ([#1262](https://github.com/developeruche/revm/pull/1262))
...
- add tests for shift instructions ([#1254](https://github.com/developeruche/revm/pull/1254))
- derive serde for OpCode, improve implementations ([#1215](https://github.com/developeruche/revm/pull/1215))
- *(interpreter)* expose mutable access methods on stack and memory ([#1219](https://github.com/developeruche/revm/pull/1219))
- *(interpreter)* export utility macros ([#1203](https://github.com/developeruche/revm/pull/1203))
...
- *(interpreter)* OpCode struct constants ([#1173](https://github.com/developeruche/revm/pull/1173))
...
- *(interpreter)* relax `make_boxed_instruction_table::FN` to `FnMut` ([#1076](https://github.com/developeruche/revm/pull/1076))
- tweeks for v4.0 revm release ([#1048](https://github.com/developeruche/revm/pull/1048))
- add `BytecodeLocked::original_bytecode` ([#1037](https://github.com/developeruche/revm/pull/1037))
...
- add some conversions to InstructionResult ([#910](https://github.com/developeruche/revm/pull/910))
- *(examples)* generate block traces ([#895](https://github.com/developeruche/revm/pull/895))
- implement Default for InstructionResult ([#878](https://github.com/developeruche/revm/pull/878))
...
- remove unneccesary var and if branch in gas calc ([#592](https://github.com/developeruche/revm/pull/592))
- State with account status ([#499](https://github.com/developeruche/revm/pull/499))
- introduce initcode size limit check taking config into account ([#587](https://github.com/developeruche/revm/pull/587))
- EIP-1153 Transient storage opcodes ([#546](https://github.com/developeruche/revm/pull/546))
- Rename all SHA3 opcodes to KECCAK256 ([#514](https://github.com/developeruche/revm/pull/514))
- *(cancun)* EIP-5656: MCOPY - Memory copying instruction ([#528](https://github.com/developeruche/revm/pull/528))
- add Memory::into_data ([#516](https://github.com/developeruche/revm/pull/516))
- simplify BYTE opcode ([#512](https://github.com/developeruche/revm/pull/512))
...
- use singular bytes for the jumpmap ([#402](https://github.com/developeruche/revm/pull/402))
- extend SuccessOrHalt ([#405](https://github.com/developeruche/revm/pull/405))
...
- Staticcall internal return ([#349](https://github.com/developeruche/revm/pull/349))
...
- *(bytecode)* mark `Bytecode::new_analyzed` as unsafe ([#3557](https://github.com/developeruche/revm/pull/3557))
- Remove unused gas-related functions ([#3534](https://github.com/developeruche/revm/pull/3534))
- *(interpreter)* swap/swapn/exchange report StackOverflow on underflow ([#3483](https://github.com/developeruche/revm/pull/3483))
- *(bytecode)* improve analyze_legacy padding for SWAPN/DUPN/EXCHANGE ([#3332](https://github.com/developeruche/revm/pull/3332))
- *(create)* Fix CreateInputs::created_address Cache invalidation ([#3222](https://github.com/developeruche/revm/pull/3222))
- correctly handle selfdestruct cold load ([#3174](https://github.com/developeruche/revm/pull/3174))
- hook up Cfg::memory_limit ([#3129](https://github.com/developeruche/revm/pull/3129))
- return MemoryLimitOOG when memory_limit is enabled ([#3109](https://github.com/developeruche/revm/pull/3109))
- support legacy JumpTable serde format ([#3098](https://github.com/developeruche/revm/pull/3098))
- remove redundant U256::from on Host getters in instructions ([#3053](https://github.com/developeruche/revm/pull/3053))
- *(interpreter)* remove redundant stack underflow check in LOG instruction ([#3028](https://github.com/developeruche/revm/pull/3028))
- unsafe stack capacity invariant and serde deserialization assumptions ([#3025](https://github.com/developeruche/revm/pull/3025))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/developeruche/revm/pull/2978))
- skip cold load on oog ([#2903](https://github.com/developeruche/revm/pull/2903))
- *(interpreter)* correct CreateContractStartingWithEF halt mapping ([#2890](https://github.com/developeruche/revm/pull/2890))
- map new once and for all (+ci) ([#2852](https://github.com/developeruche/revm/pull/2852))
- features and check in ci ([#2766](https://github.com/developeruche/revm/pull/2766))
- *(inspector)* fix call return with Some ([#2469](https://github.com/developeruche/revm/pull/2469))
- skip account list for legacy ([#2400](https://github.com/developeruche/revm/pull/2400))
...
- set zero if blockhash is out of range ([#2173](https://github.com/developeruche/revm/pull/2173))
- make macro crate-agnostic ([#1802](https://github.com/developeruche/revm/pull/1802))
- add DATACOPY to OpCode::modifies_memory ([#1639](https://github.com/developeruche/revm/pull/1639))
- *(EOF)* returning to non-returning jumpf, enable valition error ([#1664](https://github.com/developeruche/revm/pull/1664))
- *(EOF)* Validate code access in stack ([#1659](https://github.com/developeruche/revm/pull/1659))
- *(eof)* deny static context in EOFCREATE ([#1644](https://github.com/developeruche/revm/pull/1644))
- *(eof)* don't fail if offset overflows usize ([#1627](https://github.com/developeruche/revm/pull/1627))
- *(eip7702)* Add tests and fix some bugs ([#1605](https://github.com/developeruche/revm/pull/1605))
- *(EOF)* MIN_CALLEE_GAS light failure, static-mode check ([#1599](https://github.com/developeruche/revm/pull/1599))
- *(eof)* ExtDelegateCall caller/target switch ([#1571](https://github.com/developeruche/revm/pull/1571))
...
- *(EOF)* set CallOrCreate result in EOFCREATE ([#1535](https://github.com/developeruche/revm/pull/1535))
- *(EOF)* target needed for EOFCREATE created address ([#1536](https://github.com/developeruche/revm/pull/1536))
- *(EOF)* ext*call return values ([#1515](https://github.com/developeruche/revm/pull/1515))
- *(EOF)* Remove redundunt ext call gas cost ([#1513](https://github.com/developeruche/revm/pull/1513))
- *(EOF)* add DATACOPY copy gas ([#1510](https://github.com/developeruche/revm/pull/1510))
- *(EOF)* extstaticcall make static ([#1508](https://github.com/developeruche/revm/pull/1508))
- *(EOF)* jumpf gas was changes ([#1507](https://github.com/developeruche/revm/pull/1507))
- *(EOF)* panic on empty input range, and continue exec after eofcreate ([#1477](https://github.com/developeruche/revm/pull/1477))
- *(eof)* EOFCREATE spend gas and apply 63/64 rule ([#1471](https://github.com/developeruche/revm/pull/1471))
- *(stack)* pop with five items was not correct ([#1472](https://github.com/developeruche/revm/pull/1472))
- *(EOF)* returncontract immediate is one byte ([#1468](https://github.com/developeruche/revm/pull/1468))
- *(Interpreter)* wrong block number used ([#1458](https://github.com/developeruche/revm/pull/1458))
- *(interpreter)* avoid overflow when checking if mem limit reached ([#1429](https://github.com/developeruche/revm/pull/1429))
...
- correct some stack IO ([#1302](https://github.com/developeruche/revm/pull/1302))
- replace tuple in sstore return with struct ([#1115](https://github.com/developeruche/revm/pull/1115))
- *(db)* Set instruction result at outcome insert ([#1117](https://github.com/developeruche/revm/pull/1117))
- rename and pass optimism-default-handler to revm-primitives ([#1098](https://github.com/developeruche/revm/pull/1098))
- *(Interpreter)* is_revert should call is_revert ([#1007](https://github.com/developeruche/revm/pull/1007))
- cast overflow in 32-bits OS ([#978](https://github.com/developeruche/revm/pull/978))
...
- *(interpreter)* Stack `push_slice` fix and dup with pointers ([#837](https://github.com/developeruche/revm/pull/837))
- dont override instruction result ([#736](https://github.com/developeruche/revm/pull/736))
- fix typos ([#620](https://github.com/developeruche/revm/pull/620))
- fix mcopy memory expansion. Add eth tests to ci ([#586](https://github.com/developeruche/revm/pull/586))
- *(interpreter)* mcopy call order ([#570](https://github.com/developeruche/revm/pull/570))
- *(doc)* Inline documentation of re-exports ([#560](https://github.com/developeruche/revm/pull/560))
- replace SHA3 with KECCAK256 opcode name ([#511](https://github.com/developeruche/revm/pull/511))
...
- *(interpreter)* halt on CreateInitcodeSizeLimit ([#412](https://github.com/developeruche/revm/pull/412))
- using pop_top instead of pop in eval_exp ([#379](https://github.com/developeruche/revm/pull/379))
- fix bug introduced in last commit

### Other

- enable and fix clippy::missing_const_for_fn ([#3592](https://github.com/developeruche/revm/pull/3592))
- *(interpreter)* separate instruction and gas tables ([#3561](https://github.com/developeruche/revm/pull/3561))
- thread reservoir through OOG constructors ([#3580](https://github.com/developeruche/revm/pull/3580))
- pass reservoir into `first_frame_input` ([#3578](https://github.com/developeruche/revm/pull/3578))
- *(interpreter)* dedup account loading across host instructions ([#3562](https://github.com/developeruche/revm/pull/3562))
- rm op-revm (migrated to ethereum-optimism/optimism) ([#3568](https://github.com/developeruche/revm/pull/3568))
- *(interpreter)* remove unused loop_control module ([#3555](https://github.com/developeruche/revm/pull/3555))
- release ([#3472](https://github.com/developeruche/revm/pull/3472))
- deprecate set_spec and clean up deprecation attrs ([#3550](https://github.com/developeruche/revm/pull/3550))
- remove option for known bytecode ([#3532](https://github.com/developeruche/revm/pull/3532))
- simplify stack dup ([#3478](https://github.com/developeruche/revm/pull/3478))
- bump revm-interpreter to v34.0.0 and update changelogs (v107) ([#3475](https://github.com/developeruche/revm/pull/3475))
- release ([#3316](https://github.com/developeruche/revm/pull/3316))
- [**breaking**] flatten Bytecode ([#3375](https://github.com/developeruche/revm/pull/3375))
- *(interpreter)* deduplicate slice range logic ([#3376](https://github.com/developeruche/revm/pull/3376))
- remove GPL mention and update gmp feature comments ([#3383](https://github.com/developeruche/revm/pull/3383))
- elide some jumps in jump ([#3347](https://github.com/developeruche/revm/pull/3347))
- remove outdated stack pop TODO ([#3315](https://github.com/developeruche/revm/pull/3315))
...
- add optimization for push and pop ([#3263](https://github.com/developeruche/revm/pull/3263))
- happy new year, 2026 licence ([#3272](https://github.com/developeruche/revm/pull/3272))
- avoid loading bytecode in extcodehash ([#3261](https://github.com/developeruche/revm/pull/3261))
- *(clippy)* remove unused imports ([#3227](https://github.com/developeruche/revm/pull/3227))
...
- add eq/serde for InitialAndFloorGas ([#3147](https://github.com/developeruche/revm/pull/3147))
- *(interpreter)* deprecate public otry! macro ([#3146](https://github.com/developeruche/revm/pull/3146))
...
- *(instructions)* fix typo in spurious_dragon variable ([#3106](https://github.com/developeruche/revm/pull/3106))
- release ([#3102](https://github.com/developeruche/revm/pull/3102))
- release ([#3079](https://github.com/developeruche/revm/pull/3079))
- make CallInput::bytes accept immutable ContextTr ([#3082](https://github.com/developeruche/revm/pull/3082))
- release ([#3061](https://github.com/developeruche/revm/pull/3061))
- remove deprecated methods ([#3050](https://github.com/developeruche/revm/pull/3050))
...
- expose stack data ([#3047](https://github.com/developeruche/revm/pull/3047))
- use offset_from_unsigned ([#2999](https://github.com/developeruche/revm/pull/2999))
- rm eof comments ([#2987](https://github.com/developeruche/revm/pull/2987))
- comments on EIP-2929/2930 constants ([#2969](https://github.com/developeruche/revm/pull/2969))
- add SECURITY.md ([#2956](https://github.com/developeruche/revm/pull/2956))
- remove duplicate comment for TOTAL_COST_FLOOR_PER_TOKEN constant ([#2950](https://github.com/developeruche/revm/pull/2950))
- clean static_selfdestruct_cost ([#2944](https://github.com/developeruche/revm/pull/2944))
- rename SELFDESTRUCT to SELFDESTRUCT_REFUND ([#2937](https://github.com/developeruche/revm/pull/2937))
...
- *(deps)* bump ruint ([#2811](https://github.com/developeruche/revm/pull/2811))
- specialize halt, making instruction code very slightly smaller ([#2840](https://github.com/developeruche/revm/pull/2840))
- update README.md ([#2842](https://github.com/developeruche/revm/pull/2842))
- add debug assertions to set_action ([#2832](https://github.com/developeruche/revm/pull/2832))
- improve ExtBytecode hash handling ([#2826](https://github.com/developeruche/revm/pull/2826))
- fix inspector, cleanup loop ([#2797](https://github.com/developeruche/revm/pull/2797))
- start InstructionResult at 1 ([#2802](https://github.com/developeruche/revm/pull/2802))
- fix typos ([#2800](https://github.com/developeruche/revm/pull/2800))
- improve inspector loop ([#2776](https://github.com/developeruche/revm/pull/2776))
- add rust-version and note about MSRV ([#2789](https://github.com/developeruche/revm/pull/2789))
- collapse debug info for interpreter macros ([#2780](https://github.com/developeruche/revm/pull/2780))
- release ([#2771](https://github.com/developeruche/revm/pull/2771))
- un-Box frames ([#2761](https://github.com/developeruche/revm/pull/2761))
- interpreter improvements ([#2760](https://github.com/developeruche/revm/pull/2760))
- evaluate instruction table initializer at compile time ([#2762](https://github.com/developeruche/revm/pull/2762))
- discard generic host implementation ([#2738](https://github.com/developeruche/revm/pull/2738))
- add release safety section for SharedMemory fn ([#2718](https://github.com/developeruche/revm/pull/2718))
- *(interpreter)* update docs for slice_mut and slice_range ([#2714](https://github.com/developeruche/revm/pull/2714))
- release ([#2682](https://github.com/developeruche/revm/pull/2682))
- simplify gas calculations by introducing a used() method ([#2703](https://github.com/developeruche/revm/pull/2703))
...
- lints handler inspector interpreter ([#2646](https://github.com/developeruche/revm/pull/2646))
- bump all deps ([#2647](https://github.com/developeruche/revm/pull/2647))
- re-use frame allocation ([#2636](https://github.com/developeruche/revm/pull/2636))
- make CallInput default 0..0 ([#2621](https://github.com/developeruche/revm/pull/2621))
- release ([#2577](https://github.com/developeruche/revm/pull/2577))
- ContextTr rm *_ref, and add *_mut fn ([#2560](https://github.com/developeruche/revm/pull/2560))
- simplify Interpreter loop ([#2544](https://github.com/developeruche/revm/pull/2544))
- Add InstructionContext instead of Host and Interpreter ([#2548](https://github.com/developeruche/revm/pull/2548))
...
- add Gas::memory and memory_mut ([#2537](https://github.com/developeruche/revm/pull/2537))
- make crates.io version badge clickable ([#2526](https://github.com/developeruche/revm/pull/2526))
- fix clippy ([#2523](https://github.com/developeruche/revm/pull/2523))
- Storage Types Alias ([#2461](https://github.com/developeruche/revm/pull/2461))
...
- Add Bytecode address to Interpreter ([#2479](https://github.com/developeruche/revm/pull/2479))
- make ReturnDataImpl and LoopControlImpl public ([#2470](https://github.com/developeruche/revm/pull/2470))
- copy edit The Book ([#2463](https://github.com/developeruche/revm/pull/2463))
- Replace InterpreterAction with InterpreterTypes::Output ([#2424](https://github.com/developeruche/revm/pull/2424))
- simplify reading signed integers ([#2456](https://github.com/developeruche/revm/pull/2456))
- *(revm-interpreter)* remove unused deps ([#2447](https://github.com/developeruche/revm/pull/2447))
...
- *(test)* uncommented bitwise.rs and system.rs tests ([#2370](https://github.com/developeruche/revm/pull/2370))
...
- remove redundant clone ([#2293](https://github.com/developeruche/revm/pull/2293))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/developeruche/revm/pull/2299))
- make number more readable ([#2300](https://github.com/developeruche/revm/pull/2300))
...
- make clippy happy ([#2274](https://github.com/developeruche/revm/pull/2274))
- fix clippy ([#2238](https://github.com/developeruche/revm/pull/2238))
...
- docs and cleanup (rm Custom Inst) ([#2151](https://github.com/developeruche/revm/pull/2151))
...
- add immutable gas API to LoopControl ([#2134](https://github.com/developeruche/revm/pull/2134))
- expose popn macros ([#2113](https://github.com/developeruche/revm/pull/2113))
- Add docs to revm-bytecode crate ([#2108](https://github.com/developeruche/revm/pull/2108))
- fix wrong comment & remove useless struct ([#2105](https://github.com/developeruche/revm/pull/2105))
...
- add default generics for InterpreterTypes ([#2070](https://github.com/developeruche/revm/pull/2070))
- Check performance of gas with i64 #1884 ([#2062](https://github.com/developeruche/revm/pull/2062))
- Bump licence year to 2025 ([#2058](https://github.com/developeruche/revm/pull/2058))
- relax halt reason bounds ([#2041](https://github.com/developeruche/revm/pull/2041))
- remove duplicate instructions ([#2029](https://github.com/developeruche/revm/pull/2029))
- align crates versions ([#1983](https://github.com/developeruche/revm/pull/1983))
- Add bytecode hash in interpreter #1888 ([#1952](https://github.com/developeruche/revm/pull/1952))
- Make inspector use generics, rm associated types ([#1934](https://github.com/developeruche/revm/pull/1934))
- use MemoryOOG ([#1941](https://github.com/developeruche/revm/pull/1941))
...
- implement serde for interpreter ([#1909](https://github.com/developeruche/revm/pull/1909))
- make ExtBytecode pointer private ([#1904](https://github.com/developeruche/revm/pull/1904))
- Update README.md examples section ([#1853](https://github.com/developeruche/revm/pull/1853))
- fix typos ([#1868](https://github.com/developeruche/revm/pull/1868))
- *(primitives)* replace HashMap re-exports with alloy_primitives::map ([#1805](https://github.com/developeruche/revm/pull/1805))
- refactor -copy common code ([#1799](https://github.com/developeruche/revm/pull/1799))
- add ReentrancySentryOOG for SSTORE ([#1795](https://github.com/developeruche/revm/pull/1795))
...
- improve `InstructionResult` documentation ([#1673](https://github.com/developeruche/revm/pull/1673))
- Add EOF Layout Fuzz Loop to `revme bytecode` ([#1677](https://github.com/developeruche/revm/pull/1677))
- *(eof)* Add opcodes that expand memory ([#1665](https://github.com/developeruche/revm/pull/1665))
...
- *(eof)* avoid some allocations ([#1632](https://github.com/developeruche/revm/pull/1632))
...
- simplify Interpreter serde ([#1544](https://github.com/developeruche/revm/pull/1544))
- *(interpreter)* use U256::arithmetic_shr in SAR ([#1525](https://github.com/developeruche/revm/pull/1525))
...
- *(revme)* add new line in revme EOF printer ([#1503](https://github.com/developeruche/revm/pull/1503))
- remove old deprecated items ([#1489](https://github.com/developeruche/revm/pull/1489))
- *(interpreter)* use max gas limit in `impl Default for Interpreter` ([#1478](https://github.com/developeruche/revm/pull/1478))
- *(interpreter)* optimisation for BYTE, SHL, SHR and SAR ([#1418](https://github.com/developeruche/revm/pull/1418))
...
- *(EOF)* rename extcall opcode/names ([#1416](https://github.com/developeruche/revm/pull/1416))
- point to gas! in Gas::record_cost ([#1413](https://github.com/developeruche/revm/pull/1413))
- pop_address should use crate scope ([#1410](https://github.com/developeruche/revm/pull/1410))
- Remove Host constrain from calc_call_gas ([#1409](https://github.com/developeruche/revm/pull/1409))
...
- remove unused file ([#1379](https://github.com/developeruche/revm/pull/1379))
- *(interpreter)* branch less in as_usize_or_fail ([#1374](https://github.com/developeruche/revm/pull/1374))
- re-use num_words in gas::cost_per_word ([#1371](https://github.com/developeruche/revm/pull/1371))
- *(interpreter)* rewrite gas accounting for memory expansion ([#1361](https://github.com/developeruche/revm/pull/1361))
- remove bounds check in DUP, SWAP/EXCHANGE ([#1346](https://github.com/developeruche/revm/pull/1346))
- don't clone bytes in `Bytecode::bytes` ([#1344](https://github.com/developeruche/revm/pull/1344))
- shrink OpCodeInfo and add more methods ([#1307](https://github.com/developeruche/revm/pull/1307))
- *(interpreter)* rename some macros ([#1304](https://github.com/developeruche/revm/pull/1304))
- *(interpreter)* remove EOF branch in CODE{SIZE,COPY} ([#1308](https://github.com/developeruche/revm/pull/1308))
- fix some warnings ([#1305](https://github.com/developeruche/revm/pull/1305))
- *(interpreter)* rename wrapping_* opcodes ([#1306](https://github.com/developeruche/revm/pull/1306))
- Add the modifies_memory macro ([#1270](https://github.com/developeruche/revm/pull/1270))
...
- move div by zero check from smod to i256_mod ([#1248](https://github.com/developeruche/revm/pull/1248))
...
- *(interpreter)* don't run signextend with 31 too ([#1222](https://github.com/developeruche/revm/pull/1222))
...
- *(interpreter)* use already-computed sign in SAR ([#1147](https://github.com/developeruche/revm/pull/1147))
- *(interpreter)* factor out jump logic ([#1146](https://github.com/developeruche/revm/pull/1146))
...
- adding more test for i256 ([#1090](https://github.com/developeruche/revm/pull/1090))
...
- *(Interpreter)* Split calls to separate functions ([#1005](https://github.com/developeruche/revm/pull/1005))
- expose InstructionResult getters in Interpreter result ([#1002](https://github.com/developeruche/revm/pull/1002))
...
- *(interpreter)* consistency in all_results_are_covered() ([#961](https://github.com/developeruche/revm/pull/961))
- *(interpreter)* local return_error! macro ([#956](https://github.com/developeruche/revm/pull/956))
- *(interpreter)* simplify the logic of calc.new_cost() ([#939](https://github.com/developeruche/revm/pull/939))
- *(interpreter)* fix the name of the macro referenced by record_memory() ([#926](https://github.com/developeruche/revm/pull/926))
- *(interpreter)* conditionally enable `optional_beneficiary_reward` ([#925](https://github.com/developeruche/revm/pull/925))
...
- fix case for CreateInitCodeSizeLimit error ([#896](https://github.com/developeruche/revm/pull/896))
- simplify use statements ([#864](https://github.com/developeruche/revm/pull/864))
- *(interpreter)* use the constants from primitives ([#861](https://github.com/developeruche/revm/pull/861))
- review safety comments ([#811](https://github.com/developeruche/revm/pull/811))
- rewrite `Stack::push_slice` to allow arbitrary lengths ([#812](https://github.com/developeruche/revm/pull/812))
- make context memory pub ([#831](https://github.com/developeruche/revm/pull/831))
...
- make memory-limit private ([#796](https://github.com/developeruche/revm/pull/796))
...
- *(deps)* bump proptest from 1.2.0 to 1.3.1 ([#763](https://github.com/developeruche/revm/pull/763))
...
- *(interpreter)* remove dynamic dispatch from all instructions ([#739](https://github.com/developeruche/revm/pull/739))
- BLOBBASEFEE opcode ([#721](https://github.com/developeruche/revm/pull/721))
...
- *(cfg)* convert chain_id from u256 to u64 ([#693](https://github.com/developeruche/revm/pull/693))
- accept byte slice as input ([#700](https://github.com/developeruche/revm/pull/700))
- deprecate `RefDBWrapper` ([#696](https://github.com/developeruche/revm/pull/696))
- *(deps)* bump proptest-derive from 0.3.0 to 0.4.0 ([#652](https://github.com/developeruche/revm/pull/652))
- *(interpreter)* improve i256 instructions ([#630](https://github.com/developeruche/revm/pull/630))
- *(interpreter)* improve gas calculations ([#632](https://github.com/developeruche/revm/pull/632))
- *(interpreter)* use `let else` ([#629](https://github.com/developeruche/revm/pull/629))
- *(interpreter)* improve dummy host ([#631](https://github.com/developeruche/revm/pull/631))
...
- make calc public  ([#575](https://github.com/developeruche/revm/pull/575))
...
- Add back `spec_gas_opcode` ([#446](https://github.com/developeruche/revm/pull/446))
...
- Fix panic! message ([#431](https://github.com/developeruche/revm/pull/431))
- *(deps)* bump arbitrary from 1.2.3 to 1.3.0 ([#428](https://github.com/developeruche/revm/pull/428))
...
- add display impl for Opcode ([#406](https://github.com/developeruche/revm/pull/406))
...
- *(deps)* bump proptest from 1.0.0 to 1.1.0 ([#358](https://github.com/developeruche/revm/pull/358))
- revm-precompiles to revm-precompile
- set local crates versions
- nits and num of cargo keyword to 5 ([#351](https://github.com/developeruche/revm/pull/351))
...
- Wrap all calls to interpreter.gas.erase_cost with checks if USE_GAS is enabled ([#346](https://github.com/developeruche/revm/pull/346))
...
- enable proptest with arbitrary feature ([#323](https://github.com/developeruche/revm/pull/323))

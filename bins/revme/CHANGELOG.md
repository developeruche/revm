...
## [15.0.0](https://github.com/developeruche/revm/compare/revme-v14.0.0...revme-v15.0.0) - 2026-04-23

### Added

- add EIP-8037 / TIP-1016 state gas support ([#3406](https://github.com/developeruche/revm/pull/3406))
- *(revme)* list all failed tests at the end with --keep-going ([#3491](https://github.com/developeruche/revm/pull/3491))
- *(precompile)* add aws-lc-rs as alternative backend for secp256r1 ([#3451](https://github.com/developeruche/revm/pull/3451))
- *(revme)* add --json output flag to evmrunner command ([#3428](https://github.com/developeruche/revm/pull/3428))
- *(revme)* validate block gas used in blockchain tests ([#3416](https://github.com/developeruche/revm/pull/3416))
- *(revme)* add --omit-progress flag to statetest command ([#3419](https://github.com/developeruche/revm/pull/3419))
...
- DatabaseCommitExt + increment_balances ([#3195](https://github.com/developeruche/revm/pull/3195))
- sort accounts by address in blockchaintest output ([#3182](https://github.com/developeruche/revm/pull/3182))
...
- count inspector and bench test ([#2730](https://github.com/developeruche/revm/pull/2730))
...
- Add criterion to revme bench command ([#2295](https://github.com/developeruche/revm/pull/2295))
- InspectEvm fn renames, inspector docs, book cleanup ([#2275](https://github.com/developeruche/revm/pull/2275))
- rename inspect_previous to inspect_replay ([#2194](https://github.com/developeruche/revm/pull/2194))
...
- *(op)* Isthmus precompiles ([#2054](https://github.com/developeruche/revm/pull/2054))
...
- bump eof validation tests ([#1963](https://github.com/developeruche/revm/pull/1963))
- simplify Transaction trait ([#1959](https://github.com/developeruche/revm/pull/1959))
- Split inspector.rs ([#1958](https://github.com/developeruche/revm/pull/1958))
...
- extract statetest models/structs to standalone crate ([#1808](https://github.com/developeruche/revm/pull/1808))
- Merge validation/analyzis with Bytecode ([#1793](https://github.com/developeruche/revm/pull/1793))
- restructure part3 fix examples  ([#1792](https://github.com/developeruche/revm/pull/1792))
...
- use TestAuthorization and skip decoding of eip7702 tx ([#1785](https://github.com/developeruche/revm/pull/1785))
...
- *(statetest)* enable EOF in Prague tests ([#1753](https://github.com/developeruche/revm/pull/1753))
...
- *(EOF)* Run EOF tests from eth/tests ([#1690](https://github.com/developeruche/revm/pull/1690))
- *(EOF)* add evmone test suite ([#1689](https://github.com/developeruche/revm/pull/1689))
- *(EOF)* Add EOF validation in revme bytecode cmd ([#1660](https://github.com/developeruche/revm/pull/1660))
...
- *(revme)* add prague spec ([#1506](https://github.com/developeruche/revm/pull/1506))
- *(precompile)* Prague - EIP-2537 - BLS12-381 curve operations ([#1389](https://github.com/developeruche/revm/pull/1389))
- add trace option in `revme evm` ([#1376](https://github.com/developeruche/revm/pull/1376))
- *(revme)* add --keep-going to statetest command ([#1277](https://github.com/developeruche/revm/pull/1277))
...
- add evm script ([#1039](https://github.com/developeruche/revm/pull/1039))
...
- *(revme)* make it runnable by goevmlab ([#990](https://github.com/developeruche/revm/pull/990))
...
- *(revme)* format kzg setup ([#818](https://github.com/developeruche/revm/pull/818))
...
- *(revme)* use transact state for debug "State after" output ([#3498](https://github.com/developeruche/revm/pull/3498))
- *(revme)* guard unconditional println in blockchaintest for --json mode ([#3500](https://github.com/developeruche/revm/pull/3500))
- incorrect bytecode value in blockchain test error output ([#3288](https://github.com/developeruche/revm/pull/3288))
- use expected_exception instead of error field for unexpected_success status ([#3244](https://github.com/developeruche/revm/pull/3244))
- deduplicate post-state validation error handling ([#3228](https://github.com/developeruche/revm/pull/3228))
- *(revme)* incorrect debug log message in btest ([#3233](https://github.com/developeruche/revm/pull/3233))
- *(statetest)* use spec-aware blob base fee update fraction ([#3210](https://github.com/developeruche/revm/pull/3210))
- *(revme)* use primitive hashmap in statetest ([#3137](https://github.com/developeruche/revm/pull/3137))
- *(revme)* Insert block hashes in State ([#3024](https://github.com/developeruche/revm/pull/3024))
- support 0x prefix in evmrunner hex input ([#2970](https://github.com/developeruche/revm/pull/2970))
- *(revme)* Avoid panic on non-UTF filenames in statetest runner ([#2948](https://github.com/developeruche/revm/pull/2948))
- fully deprecate serde-json ([#2767](https://github.com/developeruche/revm/pull/2767))
- *(revme)* evm command caller/target for bench ([#2476](https://github.com/developeruche/revm/pull/2476))
- correct eof kind in verification tests ([#2250](https://github.com/developeruche/revm/pull/2250))
- *(revme)* Statetest stop exec when print output is true ([#1995](https://github.com/developeruche/revm/pull/1995))
- *(revme)* statetest remove redundant json output ([#1994](https://github.com/developeruche/revm/pull/1994))
- *(eof)* dont run precompile on ext delegate call ([#1964](https://github.com/developeruche/revm/pull/1964))
- *(revme)* Burntpix bench ([#1937](https://github.com/developeruche/revm/pull/1937))
- *(revme)* include correct bytecode for snailtracer  ([#1917](https://github.com/developeruche/revm/pull/1917))
- statetest json set spec_id ([#1766](https://github.com/developeruche/revm/pull/1766))
- *(statetest)* make bytecode analyzed ([#1666](https://github.com/developeruche/revm/pull/1666))
- *(EOF)* returning to non-returning jumpf, enable valition error ([#1664](https://github.com/developeruche/revm/pull/1664))
- *(statetest)* Add back Merge spec ([#1658](https://github.com/developeruche/revm/pull/1658))
...
- *(revme)* Print one json outcome in statetest ([#1347](https://github.com/developeruche/revm/pull/1347))
- Drops check for .json when testing a single file ([#1301](https://github.com/developeruche/revm/pull/1301))
...
- *(test)* Check expect exception and revm error ([#734](https://github.com/developeruche/revm/pull/734))
...
- *(revme)* use alloy-trie instead of triehash ([#3488](https://github.com/developeruche/revm/pull/3488))
- bump revm-database-interface to v10.0.0 and all dependents (v107) ([#3474](https://github.com/developeruche/revm/pull/3474))
- *(revme)* handle system call errors ([#3465](https://github.com/developeruche/revm/pull/3465))
...
- add subcall benchmarks (1000-call variants) ([#3427](https://github.com/developeruche/revm/pull/3427))
- use fixed bytes hashmaps from alloy-core ([#3358](https://github.com/developeruche/revm/pull/3358))
- update default hardfork to Osaka (Ethereum) and Jovian (Optimism) ([#3326](https://github.com/developeruche/revm/pull/3326))
...
- *(revme)* consolidate find_all_json_tests into dir_utils ([#3262](https://github.com/developeruche/revm/pull/3262))
- happy new year, 2026 licence ([#3272](https://github.com/developeruche/revm/pull/3272))
- *(revme)* use unwrap_or_default for non-UTF8 path safety ([#3259](https://github.com/developeruche/revm/pull/3259))
- sort storage keys and test files in blockchaintest output ([#3186](https://github.com/developeruche/revm/pull/3186))
- *(revme)* extract JSON printing helper in blockchaintest ([#3257](https://github.com/developeruche/revm/pull/3257))
- remove redundant clone calls ([#3258](https://github.com/developeruche/revm/pull/3258))
...
- Update blockchaintest.rs ([#3107](https://github.com/developeruche/revm/pull/3107))
- typo eip4788  ([#3111](https://github.com/developeruche/revm/pull/3111))
...
- revme v8.2.0 and yank previous version ([#3087](https://github.com/developeruche/revm/pull/3087))
- bump eest tests v5.3.0 ([#3081](https://github.com/developeruche/revm/pull/3081))
...
- use NoOpInspector for inspector benches ([#3060](https://github.com/developeruche/revm/pull/3060))
...
- pretty print state in revme statetest ([#2979](https://github.com/developeruche/revm/pull/2979))
- Fix CLI exit code for invalid bytecode input ([#2968](https://github.com/developeruche/revm/pull/2968))
- release ([#2899](https://github.com/developeruche/revm/pull/2899))
- release ([#2873](https://github.com/developeruche/revm/pull/2873))
- codspeed sstore sload opcodes ([#2881](https://github.com/developeruche/revm/pull/2881))
- release ([#2854](https://github.com/developeruche/revm/pull/2854))
- *(benches)* rename anaysis-inspector to snailtracer-inspect ([#2834](https://github.com/developeruche/revm/pull/2834))
...
- fix clippy ([#2785](https://github.com/developeruche/revm/pull/2785))
- add gas_limit to revme evm ([#2779](https://github.com/developeruche/revm/pull/2779))
- release ([#2771](https://github.com/developeruche/revm/pull/2771))
- back to hashbrown map in revme ([#2770](https://github.com/developeruche/revm/pull/2770))
- back to better map ([#2768](https://github.com/developeruche/revm/pull/2768))
- bump develop statetests to devnet-3 ([#2754](https://github.com/developeruche/revm/pull/2754))
- add clz_50 codspeed ([#2743](https://github.com/developeruche/revm/pull/2743))
- release ([#2682](https://github.com/developeruche/revm/pull/2682))
- incorrect StorageKey and StorageValue parameter order in burntpix benchmark ([#2704](https://github.com/developeruche/revm/pull/2704))
...
- statetest runner cleanup ([#2665](https://github.com/developeruche/revm/pull/2665))
...
- use iter_batched for revme benches ([#2584](https://github.com/developeruche/revm/pull/2584))
...
- add gas-cost-estimator selected bytecodes ([#2555](https://github.com/developeruche/revm/pull/2555))
- release ([#2527](https://github.com/developeruche/revm/pull/2527))
- Change legacy statetests repo ([#2519](https://github.com/developeruche/revm/pull/2519))
...
- *(revme)* simplify repeated code ([#2432](https://github.com/developeruche/revm/pull/2432))
...
- *(revme)* remove revm-handler dependency ([#2366](https://github.com/developeruche/revm/pull/2366))
- release-plz ([#2340](https://github.com/developeruche/revm/pull/2340))
- add criterion benchmark for evm build ([#2319](https://github.com/developeruche/revm/pull/2319))
- add check for path and existence existence ([#2320](https://github.com/developeruche/revm/pull/2320))
- bump bench time, and reduce burntpix iterations ([#2315](https://github.com/developeruche/revm/pull/2315))
- update EOF validation logic and improve error handling ([#2304](https://github.com/developeruche/revm/pull/2304))
- revm v20.0.0 stable version, tag v66 ([#2294](https://github.com/developeruche/revm/pull/2294))
- group cargo imports ([#2289](https://github.com/developeruche/revm/pull/2289))
...
- improve EIP-3155 tracer ([#2033](https://github.com/developeruche/revm/pull/2033))
- align crates versions ([#1983](https://github.com/developeruche/revm/pull/1983))
- remove analysis bench inner loops ([#1936](https://github.com/developeruche/revm/pull/1936))
...
- use stderr for revme tracer. not panic on bytecode ([#1916](https://github.com/developeruche/revm/pull/1916))
- put snailtracer and analysis contracts in files ([#1911](https://github.com/developeruche/revm/pull/1911))
...
- bump EOF evmone tests to v0.13.0 ([#1816](https://github.com/developeruche/revm/pull/1816))
- *(primitives)* replace HashMap re-exports with alloy_primitives::map ([#1805](https://github.com/developeruche/revm/pull/1805))
- *(revme)* replace `structopt` with `clap` ([#1754](https://github.com/developeruche/revm/pull/1754))
...
- *(GeneralState)* skip fewer specs ([#1603](https://github.com/developeruche/revm/pull/1603))
...
- skip tests with storage check and return status ([#1452](https://github.com/developeruche/revm/pull/1452))
- release ([#1261](https://github.com/developeruche/revm/pull/1261))
- *(revme)* increment statetest bar *after* running the test ([#1377](https://github.com/developeruche/revm/pull/1377))
...
- *(deps)* bump walkdir from 2.4.0 to 2.5.0 ([#1149](https://github.com/developeruche/revm/pull/1149))
...
- *(revme)* add recovery of address from secret key ([#992](https://github.com/developeruche/revm/pull/992))
- *(log)* use alloy_primitives::Log ([#975](https://github.com/developeruche/revm/pull/975))
- *(docs)* revme readme update ([#898](https://github.com/developeruche/revm/pull/898))
- simplify use statements ([#864](https://github.com/developeruche/revm/pull/864))
- decode KZG points directly into the buffers ([#840](https://github.com/developeruche/revm/pull/840))
...
- *(deps)* bump walkdir from 2.3.3 to 2.4.0 ([#692](https://github.com/developeruche/revm/pull/692))
...
- *(deps)* bump hashbrown from 0.13.2 to 0.14.0 ([#519](https://github.com/developeruche/revm/pull/519))
- Bump v24, revm v3.3.0 ([#476](https://github.com/developeruche/revm/pull/476))
- *(deps)* bump ruint from 1.7.0 to 1.8.0 ([#465](https://github.com/developeruche/revm/pull/465))
...
- *(deps)* bump bytes from 1.3.0 to 1.4.0 ([#355](https://github.com/developeruche/revm/pull/355))
...
- Correct typo ([#282](https://github.com/developeruche/revm/pull/282))
...
- Bump revm to v2.3.0
- typos ([#263](https://github.com/developeruche/revm/pull/263))
...
- revme some cleanup ([#202](https://github.com/developeruche/revm/pull/202))
- Add support for old forks. ([#191](https://github.com/developeruche/revm/pull/191))
- add lib target, make utils public ([#185](https://github.com/developeruche/revm/pull/185))
...
- update statetest model to pass merge tests ([#133](https://github.com/developeruche/revm/pull/133))
...
- refactor to exact option combinators ([#96](https://github.com/developeruche/revm/pull/96))
- Enable statetest for Berlin/Istanbul ([#78](https://github.com/developeruche/revm/pull/78))
